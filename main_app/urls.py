...
urlpatterns = [
    ...
    path('basket/', BasketView.get_basket, name = 'basket'),
    path('basket/[POST]/', UpdateBasketView.post_basket, name = 'update_basket'),
    path('basket/[DELETE]/', DeleteBasketView.delete_basket, name = 'delete'),
